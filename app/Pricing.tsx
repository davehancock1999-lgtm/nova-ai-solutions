  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: "center", marginBottom: "60px", position: "relative" }}>
        <p style={{ color: "#06b6d4", fontSize: "11px", letterSpacing: "6px", textTransform: "uppercase", marginBottom: "16px" }}>
          ROUTE6 PRICING MATRIX
        </p>
        <h2 style={{ color: "#fff", fontSize: "clamp(32px, 6vw, 64px)", fontWeight: "900", letterSpacing: "-2px", margin: 0, lineHeight: 1 }}>
          INTELLIGENCE
          <br />
          <span style={{ color: "#06b6d4" }}>HAS A PRICE.</span>
        </h2>
        <p style={{ color: "#4b5563", fontSize: "14px", marginTop: "20px", letterSpacing: "2px" }}>
          NO SETUP FEES. CANCEL ANYTIME. DEPLOY IN MINUTES.
        </p>
      </div>
      <div style={{ display: "flex", gap: "20px", flexWrap: "wrap", justifyContent: "center", position: "relative", width: "100%", maxWidth: "1100px" }}>
        {plans.map((plan, i) => (
          <div
            key={plan.name}
            ...
            style={{
              flex: "1 1 300px",
              maxWidth: "340px",
              border: plan.highlight ? "1px solid #06b6d4" : hovered === i ? "1px solid rgba(6,182,212,0.4)" : "1px solid rgba(255,255,255,0.06)",
              borderRadius: "2px",
              padding: "40px 32px",
              background: plan.highlight ? "linear-gradient(135deg, rgba(6,182,212,0.08) 0%, rgba(0,0,0,0.8) 100%)" : "rgba(255,255,255,0.02)",
              position: "relative",
              transition: "all 0.3s ease",
              transform: plan.highlight ? "translateY(-8px)" : hovered === i ? "translateY(-4px)" : "none",
              cursor: "pointer",
            }}
          >
            ...
            {plan.highlight && (
              <div style={{ position: "absolute", top: "-12px", left: "50%", transform: "translateX(-50%)", background: "#06b6d4", color: "#000", fontSize: "10px", fontWeight: "900", letterSpacing: "3px", padding: "4px 16px" }}>
                MOST POPULAR
              </div>
            )}
            ...
            <button
              style={{ width: "100%", padding: "14px", background: plan.highlight ? "#06b6d4" : "transparent", border: `
